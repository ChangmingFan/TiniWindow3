Public Class attempttogetunsuporteddatafromsign
    ...
    Private Sub But_import_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles But_import.Click
        ...
        ' Form1.progresform_AutoCloseAtCompletion = True
        Me.Close()
    ...
    Private Sub attempttogetunsuporteddatafromsign_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'Form1.progresform_AutoCloseAtCompletion = True
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        message += "You will be able to save your changes to a file" + Constants.vbCrLf
        message += "You will be send the changes to the sign" + Constants.vbCrLf
        MsgBox(message)
    End Sub
End Class