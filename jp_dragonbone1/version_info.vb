Public Class version_info
    ...
    '072413B-JP-CMF working on using FTP to send sign data. encounterd thread issues. Next step is to marshal
    ...
    Public Const TiniWindoCompileDate As String = "20130724B"
