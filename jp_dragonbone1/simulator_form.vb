<System.Serializable()> Public Class simulator_form
    ...
    Public Sub _initialize()
        ...
        LiteCard17.ForeColor = Form1.demo_textcolor
        LiteCard18.ForeColor = Form1.demo_textcolor
        LiteCard19.ForeColor = Form1.demo_textcolor
        'CFM-
    ...
    Private Sub simulator_form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        LiteCard15.character = "F"
        LiteCard16.character = "G"
        LiteCard17.character = "H"
        LiteCard18.character = "I"
        LiteCard19.character = "J"
        'CFM-
        ...
        LiteCard17.Backcolor = Form1.Demo_CardColor
        LiteCard18.Backcolor = Form1.Demo_CardColor
        LiteCard19.Backcolor = Form1.Demo_CardColor
        'CFM--
    ...
    Private Sub Tim_trick1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Tim_trick1.Tick
        ...
        If LiteCard17.character <> Form1.LiteCard17.character Then
            LiteCard17.character = Form1.LiteCard17.character
        End If

        If LiteCard18.character <> Form1.LiteCard18.character Then
            LiteCard18.character = Form1.LiteCard18.character
        End If

        If LiteCard19.character <> Form1.LiteCard19.character Then
            LiteCard19.character = Form1.LiteCard19.character
        End If
    ...
    Public Sub cards_shape_diagup_line()
        ...
        LiteCard17.DoNotRedraw = True
        LiteCard18.DoNotRedraw = True
        LiteCard19.DoNotRedraw = True
        ...
        If LiteCard0.FontSize > maxfontsize(pattern.diagUpLine, Form1.linelength) Then
            ...
            LiteCard17.FontSize = maxfontsize(pattern.diagUpLine, Form1.linelength)
            LiteCard18.FontSize = maxfontsize(pattern.diagUpLine, Form1.linelength)
            LiteCard19.FontSize = maxfontsize(pattern.diagUpLine, Form1.linelength)
        ...
        Do
            ...
            Try
                ...
                LiteCard17.location = positions(17)
                LiteCard18.location = positions(18)
                LiteCard19.location = positions(19)
        ...
        LiteCard17.DoNotRedraw = False
        LiteCard18.DoNotRedraw = False
        LiteCard19.DoNotRedraw = False
        ...
        LiteCard17.Angle = -45 '-angle
        LiteCard18.Angle = -45 '-angle
        LiteCard19.Angle = -45 '-angle
        ...
        ElseIf Form1.settings(Form1.settingsindex.linelength) = 17 Then
            ...
            '--
        ElseIf Form1.settings(Form1.settingsindex.linelength) = 18 Then
            LiteCard17.location = New PointF(xlastcard, ylastcard)
            xstep = (LiteCard17.location.X - LiteCard0.location.X) / 17
            ystep = (LiteCard17.location.Y - LiteCard0.location.Y) / 17

        ElseIf Form1.settings(Form1.settingsindex.linelength) = 19 Then
            LiteCard18.location = New PointF(xlastcard, ylastcard)
            xstep = (LiteCard18.location.X - LiteCard0.location.X) / 18
            ystep = (LiteCard18.location.Y - LiteCard0.location.Y) / 18

        ElseIf Form1.settings(Form1.settingsindex.linelength) = 20 Then
            LiteCard19.location = New PointF(xlastcard, ylastcard)
            xstep = (LiteCard19.location.X - LiteCard0.location.X) / 20
            ystep = (LiteCard19.location.Y - LiteCard0.location.Y) / 20
        ...
        While loopcounter < Form1.settings(Form1.settingsindex.linelength) - 1
            ...
            ElseIf loopcounter = 15 Then
                ...
                LiteCard15.location = New PointF(LiteCard0.location.X + (xstep * loopcounter), LiteCard0.location.Y + (ystep * loopcounter))
            ElseIf loopcounter = 16 Then

                LiteCard16.location = New PointF(LiteCard0.location.X + (xstep * loopcounter), LiteCard0.location.Y + (ystep * loopcounter))
            ElseIf loopcounter = 17 Then

                LiteCard17.location = New PointF(LiteCard0.location.X + (xstep * loopcounter), LiteCard0.location.Y + (ystep * loopcounter))
            ElseIf loopcounter = 18 Then

                LiteCard18.location = New PointF(LiteCard0.location.X + (xstep * loopcounter), LiteCard0.location.Y + (ystep * loopcounter))
            ElseIf loopcounter = 19 Then

                LiteCard19.location = New PointF(LiteCard0.location.X + (xstep * loopcounter), LiteCard0.location.Y + (ystep * loopcounter))
            Else
    ...
    Public Sub cards_shape_vert_line()
        ...
        Do
            ...
            Try
                ...
                LiteCard17.location = New Point(x, ypositions(17))
                LiteCard18.location = New Point(x, ypositions(18))
                LiteCard19.location = New Point(x, ypositions(19))
        ...
        ElseIf Form1.settings(Form1.settingsindex.linelength) = 20 Then
            LiteCard19.location = New PointF(xlastcard, ylastcard)
            xstep = (LiteCard19.location.X - LiteCard0.location.X) / 19
            ystep = (LiteCard19.location.Y - LiteCard0.location.Y) / 19
    ...
    Private Function cardswithinviewingarea() As Boolean
        ...
        If Form1.linelength > 16 Then
            If LiteCard16.location.X < min_x Then
                Return False
            End If
        ...
        '--  why ???? ???? asked by cmf
        'jp: if it previously only went to 9 that was an error
        'the purpose of this function is to determine if sign is within the viewable region
        'it determines this by examining each card. if one is outside viewable area we stop and return false

        If Form1.linelength > 17 Then
            If LiteCard17.location.X < min_x Then
                Return False
            End If
            If LiteCard17.location.Y < min_y Then
                Return False
            End If


            If LiteCard17.location.X + LiteCard17.Width > max_x Then
                Return False
            End If

            If LiteCard17.location.Y + LiteCard17.Height > max_y Then
                Return False
            End If
        ...
        If Form1.linelength > 18 Then
            If LiteCard18.location.X < min_x Then
                Return False
            End If
            If LiteCard18.location.Y < min_y Then
                Return False
            End If


            If LiteCard18.location.X + LiteCard18.Width > max_x Then
                Return False
            End If

            If LiteCard18.location.Y + LiteCard18.Height > max_y Then
                Return False
            End If
        ...
        If Form1.linelength > 19 Then
            If LiteCard19.location.X < min_x Then
                Return False
            End If
            If LiteCard19.location.Y < min_y Then
                Return False
            End If


            If LiteCard19.location.X + LiteCard19.Width > max_x Then
                Return False
            End If

            If LiteCard19.location.Y + LiteCard19.Height > max_y Then
                Return False
            End If
    ...
    Public Sub cards_shape_HorLine()
        ...
        Do
            ...
            Try
                ...
                LiteCard17.location = New Point(xpositions(17), y)
                LiteCard18.location = New Point(xpositions(18), y)
                LiteCard19.location = New Point(xpositions(19), y)
                'Ch
    ...
    Public Function maxcarddemension() As Single
        ...
        If LiteCard17.Height > returnvalue Then

            returnvalue = LiteCard17.Height
        End If

        If LiteCard17.Width > returnvalue Then

            returnvalue = LiteCard17.Width
        End If

        If LiteCard18.Height > returnvalue Then

            returnvalue = LiteCard18.Height
        End If

        '-
        If LiteCard18.Width > returnvalue Then

            returnvalue = LiteCard18.Width
        End If

        If LiteCard19.Height > returnvalue Then

            returnvalue = LiteCard19.Height
        End If

        If LiteCard19.Width > returnvalue Then

            returnvalue = LiteCard19.Width
        End If
    ...
    Public Sub positionandsizecards()
        ...
        If Not recursive Then
            ...
            LiteCard17.FontSize = Form1.oneline_simulator_ratio * Form1.LiteCard17.FontSize
            LiteCard18.FontSize = Form1.oneline_simulator_ratio * Form1.LiteCard18.FontSize
            LiteCard19.FontSize = Form1.oneline_simulator_ratio * Form1.LiteCard19.FontSize
            ...
            LiteCard16.Angle = Form1.LiteCard16.Angle



            LiteCard17.Angle = Form1.LiteCard17.Angle
            LiteCard18.Angle = Form1.LiteCard18.Angle
            LiteCard19.Angle = Form1.LiteCard19.Angle
            'Ch
            'Changming temp 
            ...
            LiteCard17.location = New Point(Form1.oneline_simulator_ratio * Form1.LiteCard17.location.X, Form1.oneline_simulator_ratio * Form1.LiteCard17.location.Y)
            LiteCard18.location = New Point(Form1.oneline_simulator_ratio * Form1.LiteCard18.location.X, Form1.oneline_simulator_ratio * Form1.LiteCard18.location.Y)
            LiteCard19.location = New Point(Form1.oneline_simulator_ratio * Form1.LiteCard19.location.X, Form1.oneline_simulator_ratio * Form1.LiteCard19.location.Y)
    ...
    Private Sub LiteCard_common_MouseDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) _
        ...
        LiteCard13.MouseDown, LiteCard12.MouseDown, LiteCard11.MouseDown, LiteCard10.MouseDown, _
    ...
    Private Sub LiteCard_common_MouseUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) _
        ...
        LiteCard15.MouseUp, LiteCard14.MouseUp, LiteCard13.MouseUp, LiteCard12.MouseUp, LiteCard11.MouseUp, LiteCard10.MouseUp, _
         LiteCard16.MouseUp, LiteCard17.MouseUp, LiteCard18.MouseUp, LiteCard19.MouseUp
        'CFM
    ...
    Private Sub LiteCard_common_MouseMove(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) _
        ...
        LiteCard16.MouseMove, LiteCard17.MouseMove, LiteCard18.MouseMove, LiteCard19.MouseMove
        'CFM
        ...
        ElseIf curr_clickmode = clickmodes.signdrag Then
            ...
            If e.Button = Windows.Forms.MouseButtons.Left Then
                ...
                If cardclicked > -1 Then
                    ...
                    '--
                    card_curlocation = LiteCard17.location
                    card_newlocation = New PointF(card_curlocation.X + currentmouselocation.X - startmouselocation.X, card_curlocation.Y + currentmouselocation.Y - startmouselocation.Y)
                    LiteCard17.location = card_newlocation

                    card_curlocation = LiteCard18.location
                    card_newlocation = New PointF(card_curlocation.X + currentmouselocation.X - startmouselocation.X, card_curlocation.Y + currentmouselocation.Y - startmouselocation.Y)
                    LiteCard18.location = card_newlocation


                    card_curlocation = LiteCard19.location
                    card_newlocation = New PointF(card_curlocation.X + currentmouselocation.X - startmouselocation.X, card_curlocation.Y + currentmouselocation.Y - startmouselocation.Y)
                    LiteCard19.location = card_newlocation
    ...
    Private Sub setCardForecolor(ByVal cardnum As Int16, ByVal _color As Color)
        ...
        ElseIf cardnum = 17 Then
            ...
            LiteCard17.ForeColor = _color
            Form1.LiteCard17.ForeColor = _color

        ElseIf cardnum = 18 Then

            LiteCard18.ForeColor = _color
            Form1.LiteCard18.ForeColor = _color

        ElseIf cardnum = 19 Then

            LiteCard19.ForeColor = _color
            Form1.LiteCard19.ForeColor = _color
            'CFM
    ...
    Private Sub setCardBackcolor(ByVal cardnum As Int16, ByVal _color As Color)
        ...
        ElseIf cardnum = 17 Then
            ...
            LiteCard17.Backcolor = _color

        ElseIf cardnum = 18 Then

            LiteCard18.Backcolor = _color

        ElseIf cardnum = 19 Then

            LiteCard19.Backcolor = _color
            'CFM
    ...
    Private Sub Change_card_size_common_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        LiteCard17.FontSize += changeamount
        LiteCard18.FontSize += changeamount
        LiteCard19.FontSize += changeamount
    ...
    Private Sub signZoomInBig_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Lbut_EnlargeCardBig.Click, CMI_sign_zoominlarge.Click, CMI_zoominBig.Click, CMI_z00minbig.Click
        ...
        LiteCard17.FontSize *= (1 + BIGZOOMFACTOR)
        LiteCard18.FontSize *= (1 + BIGZOOMFACTOR)
        LiteCard19.FontSize *= (1 + BIGZOOMFACTOR)
        ...
        LiteCard17.Top *= (1 + BIGZOOMFACTOR)
        LiteCard18.Top *= (1 + BIGZOOMFACTOR)
        LiteCard19.Top *= (1 + BIGZOOMFACTOR)
        'CFM
        ...
        LiteCard17.Left *= (1 + BIGZOOMFACTOR)
        LiteCard18.Left *= (1 + BIGZOOMFACTOR)
        LiteCard19.Left *= (1 + BIGZOOMFACTOR)
        'CFM
    ...
    Private Sub signZoom(ByVal factor As Single)
        ...
        If True Then
            ...
            LiteCard17.FontSize *= (1 + factor)
            LiteCard18.FontSize *= (1 + factor)
            LiteCard19.FontSize *= (1 + factor)
            ...
            'get current location
            newlocation = LiteCard17.location
            ...
            'set the lite card in calculated location
            LiteCard17.location = New PointF(newlocation.X, newlocation.Y)
            'CFM stop


            'get current location
            newlocation = LiteCard18.location
            ...
            'set the lite card in calculated location
            LiteCard18.location = New PointF(newlocation.X, newlocation.Y)
            'CFM stop


            'get current location
            newlocation = LiteCard19.location
            ...
            'set the lite card in calculated location
            LiteCard19.location = New PointF(newlocation.X, newlocation.Y)
            'CFM stop
    ...
    Private Sub Label9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Lbut_SignPanUp.Click
        ...
        LiteCard17.Top -= SIGNPANAMOUNT
        LiteCard18.Top -= SIGNPANAMOUNT
        LiteCard19.Top -= SIGNPANAMOUNT
        'CFM
    ...
    Private Sub Lbut_SignPanRight_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Lbut_SignPanRight.Click
        ...
        LiteCard17.Left += SIGNPANAMOUNT
        LiteCard18.Left += SIGNPANAMOUNT
        LiteCard19.Left += SIGNPANAMOUNT
        'CFM
    ...
    Private Sub SignMove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Lbut_SignMove.Click, Pan_SignMove.Click, Pan_Pict_SignMove.Click, CMI_movesign.Click, CMI_move_sign.Click, CMI_m0vesign.Click
        ...
        LiteCard17.ContextMenuStrip = ContextMen_litecards
        LiteCard18.ContextMenuStrip = ContextMen_litecards
        LiteCard19.ContextMenuStrip = ContextMen_litecards
        'CFM
    ...
    Private Sub Timer_formloaded_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer_formloaded.Tick
        ...
        locations.Add(LiteCard17.location)
        locations.Add(LiteCard18.location)
        locations.Add(LiteCard19.location)
        'CFM
        ...
        angles.Add(LiteCard17.Angle)
        angles.Add(LiteCard18.Angle)
        angles.Add(LiteCard19.Angle)
        'CFM
        ...
        If angles(17) <> LiteCard17.Angle Then
            Timer_formloaded.Start()
            Return
        End If
        If angles(18) <> LiteCard18.Angle Then
            Timer_formloaded.Start()
            Return
        End If
        If angles(19) <> LiteCard19.Angle Then
            Timer_formloaded.Start()
            Return
        End If
        ...
        If locations(17) <> LiteCard17.location Then
            Timer_formloaded.Start()
            Return
        End If
        If locations(18) <> LiteCard18.location Then
            Timer_formloaded.Start()
            Return
        End If
        If locations(19) <> LiteCard19.location Then
            Timer_formloaded.Start()
            Return
        End If
        'CFM
            ...
            While (filetext.IndexOf("]") >= 0)
                Try 'catches bad substring calls resulting from '[' and ']' being in wrong order
                    ...
                    ElseIf (this_dataname = "LiteCard16BackColor") Then
                        ...
                        'jp start
                    ElseIf (this_dataname = "LiteCard17Top") Then
                        LiteCard17.Top = this_datavalue
                    ElseIf (this_dataname = "LiteCard17Left") Then
                        LiteCard17.Left = this_datavalue
                    ElseIf (this_dataname = "LiteCard17Height") Then
                        LiteCard17.Height = this_datavalue
                    ElseIf (this_dataname = "LiteCard17Width") Then
                        LiteCard17.Width = this_datavalue
                    ElseIf (this_dataname = "LiteCard17Angle") Then
                        LiteCard17.Angle = this_datavalue

                    ElseIf (this_dataname = "LiteCard17FontSize") Then
                        LiteCard17.FontSize = this_datavalue

                    ElseIf (this_dataname = "LiteCard17ForeColor") Then
                        'LiteCard17.ForeColor = Color.FromArgb(this_datavalue)
                        ' LiteCard0.ForeColor = Color.FromArgb(this_datavalue)
                        '9/30/2012 ignore saved color and leave default text collor showing
                        'latter on we will test if saved color is valid and either set it or set default
                    ElseIf (this_dataname = "LiteCard17BackColor") Then
                        LiteCard17.Backcolor = Color.FromArgb(this_datavalue)
                        ''''
                    ElseIf (this_dataname = "LiteCard18Top") Then
                        LiteCard18.Top = this_datavalue
                    ElseIf (this_dataname = "LiteCard18Left") Then
                        LiteCard18.Left = this_datavalue
                    ElseIf (this_dataname = "LiteCard18Height") Then
                        LiteCard18.Height = this_datavalue
                    ElseIf (this_dataname = "LiteCard18Width") Then
                        LiteCard18.Width = this_datavalue
                    ElseIf (this_dataname = "LiteCard18Angle") Then
                        LiteCard18.Angle = this_datavalue

                    ElseIf (this_dataname = "LiteCard18FontSize") Then
                        LiteCard18.FontSize = this_datavalue

                    ElseIf (this_dataname = "LiteCard18ForeColor") Then
                        'LiteCard18.ForeColor = Color.FromArgb(this_datavalue)
                        ' LiteCard0.ForeColor = Color.FromArgb(this_datavalue)
                        '9/30/2012 ignore saved color and leave default text collor showing
                        'latter on we will test if saved color is valid and either set it or set default
                    ElseIf (this_dataname = "LiteCard18BackColor") Then
                        LiteCard18.Backcolor = Color.FromArgb(this_datavalue)

                    ElseIf (this_dataname = "LiteCard19Top") Then
                        LiteCard19.Top = this_datavalue
                    ElseIf (this_dataname = "LiteCard19Left") Then
                        LiteCard19.Left = this_datavalue
                    ElseIf (this_dataname = "LiteCard19Height") Then
                        LiteCard19.Height = this_datavalue
                    ElseIf (this_dataname = "LiteCard19Width") Then
                        LiteCard19.Width = this_datavalue
                    ElseIf (this_dataname = "LiteCard19Angle") Then
                        LiteCard19.Angle = this_datavalue

                    ElseIf (this_dataname = "LiteCard19FontSize") Then
                        LiteCard19.FontSize = this_datavalue

                    ElseIf (this_dataname = "LiteCard19ForeColor") Then
                        'LiteCard19.ForeColor = Color.FromArgb(this_datavalue)
                        ' LiteCard0.ForeColor = Color.FromArgb(this_datavalue)
                        '9/30/2012 ignore saved color and leave default text collor showing
                        'latter on we will test if saved color is valid and either set it or set default
                    ElseIf (this_dataname = "LiteCard19BackColor") Then
                        LiteCard19.Backcolor = Color.FromArgb(this_datavalue)
    ...
    Private Function undoaction(ByVal flag As undoaction_flag, Optional ByVal Item As ItemReferenceEnum = ItemReferenceEnum.none) As Boolean
        ...
        ElseIf flag = undoaction_flag.finish_save Then
            ...
            Or itemWorkinWith = ItemReferenceEnum.LiteCard16 _
            Or itemWorkinWith = ItemReferenceEnum.LiteCard17 _
            Or itemWorkinWith = ItemReferenceEnum.LiteCard18 _
            Or itemWorkinWith = ItemReferenceEnum.LiteCard19 Then
                'CFM
    ...
    Public Sub ExportdisplayPattern(ByVal filename As String)
        ...
        'start jp 12/29/2012
        outputstring &= "[start LiteCard17Top]" & LiteCard17.Top & "[end LiteCard17Top]" & Constants.vbCrLf
        outputstring &= "[start LiteCard17Left]" & LiteCard17.Left & "[end LiteCard17Left]" & Constants.vbCrLf
        outputstring &= "[start LiteCard17Angle]" & LiteCard17.Angle & "[end LiteCard17Angle]" & Constants.vbCrLf
        outputstring &= "[start LiteCard17FontSize]" & LiteCard17.FontSize & "[end LiteCard17FontSize]" & Constants.vbCrLf
        outputstring &= "[start LiteCard17ForeColor]" & LiteCard17.ForeColor.ToArgb.ToString & "[end LiteCard17ForeColor]" & Constants.vbCrLf
        outputstring &= "[start LiteCard17BackColor]" & LiteCard17.Backcolor.ToArgb.ToString & "[end LiteCard17BackColor]" & Constants.vbCrLf


        outputstring &= "[start LiteCard18Top]" & LiteCard18.Top & "[end LiteCard18Top]" & Constants.vbCrLf
        outputstring &= "[start LiteCard18Left]" & LiteCard18.Left & "[end LiteCard18Left]" & Constants.vbCrLf
        outputstring &= "[start LiteCard18Angle]" & LiteCard18.Angle & "[end LiteCard18Angle]" & Constants.vbCrLf
        outputstring &= "[start LiteCard18FontSize]" & LiteCard18.FontSize & "[end LiteCard18FontSize]" & Constants.vbCrLf
        outputstring &= "[start LiteCard18ForeColor]" & LiteCard18.ForeColor.ToArgb.ToString & "[end LiteCard18ForeColor]" & Constants.vbCrLf
        outputstring &= "[start LiteCard18BackColor]" & LiteCard18.Backcolor.ToArgb.ToString & "[end LiteCard18BackColor]" & Constants.vbCrLf

        outputstring &= "[start LiteCard19Top]" & LiteCard19.Top & "[end LiteCard19Top]" & Constants.vbCrLf
        outputstring &= "[start LiteCard19Left]" & LiteCard19.Left & "[end LiteCard19Left]" & Constants.vbCrLf
        outputstring &= "[start LiteCard19Angle]" & LiteCard19.Angle & "[end LiteCard19Angle]" & Constants.vbCrLf
        outputstring &= "[start LiteCard19FontSize]" & LiteCard19.FontSize & "[end LiteCard19FontSize]" & Constants.vbCrLf
        outputstring &= "[start LiteCard19ForeColor]" & LiteCard19.ForeColor.ToArgb.ToString & "[end LiteCard19ForeColor]" & Constants.vbCrLf
        outputstring &= "[start LiteCard19BackColor]" & LiteCard19.Backcolor.ToArgb.ToString & "[end LiteCard19BackColor]" & Constants.vbCrLf
    ...
    Public Sub cards_shape_Arc()
        ...
        If LiteCard0.FontSize > Me.maxfontsize(pattern.revArch, Form1.linelength) Then
            ...
            LiteCard17.FontSize = Me.maxfontsize(pattern.revArch, Form1.linelength)
            LiteCard18.FontSize = Me.maxfontsize(pattern.revArch, Form1.linelength)
            LiteCard19.FontSize = Me.maxfontsize(pattern.revArch, Form1.linelength)
            'CFM
        ...
        Do
            ...
            While True
                ...
                curr_angle += angle_step
                LiteCard17.PositionInArk(centerofrevarch, archradius, curr_angle)

                curr_angle += angle_step
                LiteCard18.PositionInArk(centerofrevarch, archradius, curr_angle)

                curr_angle += angle_step
                LiteCard19.PositionInArk(centerofrevarch, archradius, curr_angle)
    ...
    Public Sub cards_shape_Scurve()
        ...
        If LiteCard0.FontSize > Me.maxfontsize(pattern.sCurve, cardcount) Then
            ...
            LiteCard17.FontSize = maxfontsize(pattern.sCurve, cardcount)
            LiteCard18.FontSize = maxfontsize(pattern.sCurve, cardcount)
            LiteCard19.FontSize = maxfontsize(pattern.sCurve, cardcount)
            'CFM
        ...
        While loopcounter < revarc_steps
            ...
            ElseIf loopcounter = 16 Then
                ...
                'start jp
            ElseIf loopcounter = 17 Then
                LiteCard17.PositionInArk(centerofrevarc, radius, curang)


            ElseIf loopcounter = 18 Then
                LiteCard18.PositionInArk(centerofrevarc, radius, curang)
            ElseIf loopcounter = 19 Then
                LiteCard19.PositionInArk(centerofrevarc, radius, curang)
            End If
            'end jp
        ...
        While loopcounter < cardcount
            ...
            ElseIf loopcounter = 17 Then
                LiteCard17.PositionInArk(centerofarc, radius, curang)
            ElseIf loopcounter = 18 Then
                LiteCard18.PositionInArk(centerofarc, radius, curang)
            ElseIf loopcounter = 19 Then
                LiteCard19.PositionInArk(centerofarc, radius, curang)
                'CFM
    ...
    Public Sub cards_shape_ReverseArc()
        ...
        Do
            ...
            curr_angle += angle_step
            LiteCard17.PositionInArk(centerofarch, archradius, curr_angle)

            curr_angle += angle_step
            LiteCard18.PositionInArk(centerofarch, archradius, curr_angle)

            curr_angle += angle_step
            LiteCard19.PositionInArk(centerofarch, archradius, curr_angle)
            'CFM
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        LiteCard17.rotateAroundPoint(centerofform, 1)
        LiteCard18.rotateAroundPoint(centerofform, 1)
        LiteCard19.rotateAroundPoint(centerofform, 1)
        'CFm
