Public Class ConfirmImportTricksInMonitorMode

    Private Sub ConfirmImportTricksInMonitorMode_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
